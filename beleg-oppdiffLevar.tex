...
\begin{figure}[H]\begin{center}
    ...
    \end{center}\end{minipage}
    \caption{Vergleich der Massenbruchverteilungen für \textbf{Links:} $\mathrm{Le}=1$ und \textbf{Rechts:} variable Lewis-Zahlen.}
...
\begin{figure}[H]\begin{center}
    ...
    \end{center}\end{minipage}
    \caption{Vergleich der Massenbruchverteilungen \gls{Y_i} über den Mischungsbruch \gls{Z_ULF}. Bei $\gls{Z_ULF}=1$ ist die Methandüse, bei $\gls{Z_ULF}=0$ die Luftdüse. \textbf{Links:} Diffusionsmodellierung mit stoffunabhängiger Lewis-Zahl $\mathrm{Le}=1$. \textbf{Rechts:} stoffabhängige Lewis-Zahlen. }
