...
In \autoref{fig:Le1:yi-z:cmp:oppLe} sind keine großen Unterschiede der Speziesprofile der Flameletlösung und der der Lösung im Ortsraum in. Vergleiche auch die vollständigen Ergebnisse in \autoref{fig:flameletLe1:yi-z} in Anhang~\ref{appendix:flameletLe1:yi-z} und \autoref{fig:yi-z}. Für eine genauere Auswertung also Kapitel~\ref{sct:oppdiffLe1-yi-z}.
Die Ähnlichkeit der Ergebnisse zeigt empirisch, zusätzlich zur mathematischen Herleitung, dass man die jeweilige numerisch einfachere Differentialgleichung lösen kann und damit auch die Lösung der anderen äquivalenten hat.
