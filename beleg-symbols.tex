...
\newglossaryentry{nu_ik}{
    name=\ensuremath{\nu_{ik}},
    description={Stöchiometriefaktor (oder: stöchiometrische Zahl, stöchiometrischer Koeffizient, Stöchiometriezahl) des Stoffes $i$ bezüglich der Reaktion $k$, siehe Kapitel~\ref{sct:chemreact}. Nicht zu verwechseln mit \gls{nu}},
    sort=symbolnu_ik
}
